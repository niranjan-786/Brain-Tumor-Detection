...
main = tkinter.Tk()
main.title("Brain Tumor Detection using 3D U-Net and CNN") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Brain Tumor Detection using 3D U-Net and CNN', justify=LEFT)
...
font1 = ('times', 12, 'bold')
text=Text(main,height=30,width=189)
